...
* ***Easy-to-use***: By integrating this toolkit with [JINA](https://jina.ai/), 🚀RocketQA can help developers build an end-to-end question answering system with several lines of code. <img src="https://github.com/sfwydyc/rocketqa/blob/main/RocketQA_flow.png" alt="" align=center />  
