...
class ListClassifyReader(ClassifyReader):
    def _read_tsv(self, data, batch_size=16, quotechar=None):
        """
            Reads a tab separated value from a list.
            data: [str], where str is q\tt\tp\tl
        """
